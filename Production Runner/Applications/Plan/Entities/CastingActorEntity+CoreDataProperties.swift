//
//  CastingActorEntity+CoreDataProperties.swift
//  Production Runner
//
...
extension CastingActorEntity {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<CastingActorEntity> {
        return NSFetchRequest<CastingActorEntity>(entityName: "CastingActorEntity")
    }
...
extension CastingActorEntity: Identifiable {
